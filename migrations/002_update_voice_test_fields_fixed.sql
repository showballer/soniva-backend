...
-- 1. 删除旧字段
ALTER TABLE voice_test_results DROP COLUMN voice_type_scores;
ALTER TABLE voice_test_results DROP COLUMN tags;
ALTER TABLE voice_test_results DROP COLUMN overall_score;
ALTER TABLE voice_test_results DROP COLUMN charm_index;
ALTER TABLE voice_test_results DROP COLUMN hearing_age;
ALTER TABLE voice_test_results DROP COLUMN hearing_height;
ALTER TABLE voice_test_results DROP COLUMN color_temperature;
ALTER TABLE voice_test_results DROP COLUMN emotional_summary;
ALTER TABLE voice_test_results DROP COLUMN advanced_suggestion;

-- 2. 删除 main_voice_type 上的索引
DROP INDEX ix_voice_test_results_main_voice_type ON voice_test_results;

-- 3. 修改 main_voice_type 字段类型为 JSON
